defmodule BiblioMaterializer.Sparql.Auth do
  @moduledoc """
  ...
  defp username, do: Application.fetch_env!(:biblio_materializer, :virtuoso_username)
  defp password, do: Application.fetch_env!(:biblio_materializer, :virtuoso_password)
end
