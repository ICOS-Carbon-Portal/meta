...
SELECT
    SUBSTRING(subj FROM (CASE
        WHEN subj LIKE 'http://meta.icos-cp.eu/resources/latlonboxes%' THEN 45
        WHEN subj LIKE 'http://meta.icos-cp.eu/resources/position\_%' THEN 43
        WHEN subj LIKE 'http://meta.icos-cp.eu/resources/spcov\_%' THEN 40
    END)) AS id
    , subj AS rdf_subject
    , (    CASE
            WHEN subj LIKE 'http://meta.icos-cp.eu/resources/latlonboxes%' THEN 'http://meta.icos-cp.eu/resources/latlonboxes'
            WHEN subj LIKE 'http://meta.icos-cp.eu/resources/position\_%' THEN 'http://meta.icos-cp.eu/resources/position_'
            WHEN subj LIKE 'http://meta.icos-cp.eu/resources/spcov\_%' THEN 'http://meta.icos-cp.eu/resources/spcov_'
        END) AS prefix
...
SELECT
    SUBSTRING(subj FROM (CASE
        WHEN subj LIKE 'http://meta.icos-cp.eu/resources/wdcgg/station/%' THEN 48
        WHEN subj LIKE 'http://meta.icos-cp.eu/resources/stations/%' THEN 43
        WHEN subj LIKE 'http://meta.icos-cp.eu/resources/wdcgg/%' THEN 40
        WHEN subj LIKE 'http://meta.icos-cp.eu/resources/icos/%' THEN 39
    END)) AS id
    , subj AS rdf_subject
    , (    CASE
            WHEN subj LIKE 'http://meta.icos-cp.eu/resources/wdcgg/station/%' THEN 'http://meta.icos-cp.eu/resources/wdcgg/station/'
            WHEN subj LIKE 'http://meta.icos-cp.eu/resources/stations/%' THEN 'http://meta.icos-cp.eu/resources/stations/'
            WHEN subj LIKE 'http://meta.icos-cp.eu/resources/wdcgg/%' THEN 'http://meta.icos-cp.eu/resources/wdcgg/'
            WHEN subj LIKE 'http://meta.icos-cp.eu/resources/icos/%' THEN 'http://meta.icos-cp.eu/resources/icos/'
        END) AS prefix
    ...
    , MAX(CASE WHEN pred = 'http://meta.icos-cp.eu/ontologies/cpmeta/hasSpatialCoverage' THEN SUBSTRING(obj FROM (CASE
        ...
        WHEN obj LIKE 'http://meta.icos-cp.eu/resources/spcov\_%' THEN 40
...
SELECT
    ...
    , MAX(CASE WHEN pred = 'http://www.w3.org/ns/prov#wasAssociatedWith' THEN SUBSTRING(obj FROM (CASE
        WHEN obj LIKE 'http://meta.icos-cp.eu/resources/wdcgg/station/%' THEN 48
        WHEN obj LIKE 'http://meta.icos-cp.eu/resources/stations/%' THEN 43
        WHEN obj LIKE 'http://meta.icos-cp.eu/resources/wdcgg/%' THEN 40
        WHEN obj LIKE 'http://meta.icos-cp.eu/resources/icos/%' THEN 39
