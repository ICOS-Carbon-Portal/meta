...
export const themeToFiles = {
	...
	Ecosystem: [
		...
		{min: 0, max: 1, type: etc.windDirectionFileType1, tip: "Wind sectors in rows (max 30 degrees width) and months on columns"},
		{min: 0, max: 1, type: etc.windDirectionFileType2, tip: "Maximum hourly time resolution, one full year, time vs degrees w.r.t. North"},
