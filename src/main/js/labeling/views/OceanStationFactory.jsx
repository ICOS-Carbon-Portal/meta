	...
	return React.createClass({
		...
		getForm: function() {
			...
			return <Inputs.FormForm>
				...
				<Inputs.Latitude {...this.getProps('hasNothernmostLat')} optional={true} header="Northernmost latitude [WGS84, decimal degrees]" />
