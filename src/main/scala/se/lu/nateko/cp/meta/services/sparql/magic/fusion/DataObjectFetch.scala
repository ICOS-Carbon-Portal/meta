...
class DataObjectFetch(
	...
	private val allVars = Seq(dobjVar) ++ specVar ++ dataStartTimeVar ++ dataEndTimeVar

	override def clone() = new DataObjectFetch(dobjVar, specVar, dataStartTimeVar, dataEndTimeVar, excludeDeprecated)
