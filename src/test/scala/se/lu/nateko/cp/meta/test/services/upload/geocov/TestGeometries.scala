...
object TestGeometries:
	...
	val jtsPoint = JtsGeoFactory.createPoint(Coordinate(5.449391234467299, 48.61221138915232))

	val labeledPoint = LabeledJtsGeo(jtsPoint, Seq("point"))

	val labeledPolygon1 = mkPolygon("polygon1",
	...
	val labeledPolygon2 = mkPolygon("polygon2",
	...
	val labeledPolygon3 = mkPolygon("polygon3",
